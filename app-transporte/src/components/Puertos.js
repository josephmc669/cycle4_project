...
export default class Puertos extends Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div id="content" className="app-content">
          <ol className="breadcrumb float-xl-end">
            ...
            <li className="breadcrumb-item active">Puertos</li>
          </ol>
          {/* <!-- END breadcrumb -->
			<!-- BEGIN page-header --> */}
          <h1 className="page-header">
            Listado de Puertos <small>header small text goes here...</small>
          </h1>
          {/* <!-- END page-header -->
			<!-- BEGIN nav-tabs --> */}
          <div
              ...
              <ul className="nav nav-tabs">
                ...
                <li className="nav-item">
                  <a href="#profile" data-bs-toggle="tab" className="nav-link">
                    ...
                    <span className="d-none d-md-inline">Crear Puerto</span>
                  </a>
                </li>
              </ul>
            </div>
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th className="text-nowrap">Pais</th>
